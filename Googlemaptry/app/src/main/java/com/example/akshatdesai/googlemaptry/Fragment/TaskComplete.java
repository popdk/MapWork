...
public class TaskComplete extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        taskView = (RecyclerView) view.findViewById(R.id.rv_manager_completed_task);
        final LinearLayoutManager layoutManager = new LinearLayoutManager(getContext());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        taskView.setLayoutManager(layoutManager);

        noTask = (TextView) view.findViewById(R.id.no_task_completed);
...
//                httpURLConnection.setInstanceFollowRedirects(true);
        ...
        protected void onPostExecute(Object o) {
            ...
            try {
                ...
                if(status == 1) {
                    adapter = new ViewTaskAdapter(getContext(),id, name, desc, sdate, edate, assignedto, cstatus,1);
